...
MOV EBX, 0x8989 ; 1000 1001 1000 1001
OR EAX, EBX ; expect: 1001 1111 1001 1111, i.e. 0x9f9f
...
MOV EBX, 0x0909 ; 0000 1001 0000 1001
OR EAX, EBX ; expect: 0111 1111 0111 1101, i.e. 0x7f7d
